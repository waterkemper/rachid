...
export class AuthController {
  ...
  static async me(req: Request, res: Response) {
    try {
      ...
      const referralCode = await AuthService.obterReferralCode(usuarioId);
  ...
  static async createUser(req: Request, res: Response) {
    try {
      ...
      const usuario = await AuthService.createUsuario({ 
        email, 
        senha, 
        nome, 
        ddd, 
  ...
  static async googleLogin(req: Request, res: Response) {
    try {
      ...
      const resultado = await AuthService.loginWithGoogle(tokenId);
  ...
  static async appleLogin(req: Request, res: Response) {
    try {
      ...
      const resultado = await AuthService.loginWithApple(identityToken, user, fullName, email);
   ...
   */
  static async getEmailPreferences(req: Request, res: Response) {
    try {
      const usuarioId = (req as any).usuarioId;
   ...
   */
  static async updateEmailPreferences(req: Request, res: Response) {
    try {
      const usuarioId = (req as any).usuarioId;
      ...
      const usuarioAtualizado = await AuthService.updateEmailPreferences(usuarioId, {
        receberEmails,
        emailOptOutReason,
      });
  ...
  static async deleteAccount(req: Request, res: Response) {
    try {
      ...
      const resultado = await AuthService.deleteAccount(usuarioId);
